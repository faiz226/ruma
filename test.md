...
CREATE TABLE public.rooms (
  ...
  description       text,
  base_price_cents  integer NOT NULL, -- NOTE: Unused. Pricing is calculated dynamically by day-of-week client/server-side.
...
```
VITE_SUPABASE_URL=**censored**
VITE_SUPABASE_PUBLISHABLE_KEY=**censored**
```
